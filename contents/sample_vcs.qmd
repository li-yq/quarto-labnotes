...
```markdown
<!-- git shortcode in paragraphs and links -->
[link to Git icon]({{{< git assets/git.svg rev=ed3aedfa >}}}) points to
{{{< git assets/git.svg rev=ed3aedfa >}}} and
[link to Git icon (colored)]({{{< git assets/git.svg rev=4bfbd3dc >}}}) points to
{{{< git assets/git.svg rev=4bfbd3dc >}}}.

<!-- git shortcode in images -->
![Git icon image]({{{< git assets/git.svg rev=ed3aedfa >}}})
![Git icon image (colored)]({{{< git assets/git.svg rev=4bfbd3dc >}}})
```
